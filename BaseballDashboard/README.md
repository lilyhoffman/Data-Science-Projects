...
The teams_columns_keys table contains the column names of showable statistics matched with a description of what they are. This is used in the dashboard dropdown for Statistics so that the user can know what stat they are choosing to look at.
